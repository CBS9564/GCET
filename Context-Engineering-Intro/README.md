...
[git clone https://github.com/CBS9564/GCET.git
...
- `Customize GEMINI.md` - See how it researches and creates PRPs
...
- [Gemini CLI Documentation](https://ai.google.dev/docs/gemini-api)
